...
// ubah date format ke MySQL datetime wib
...
try {
    ...
    // Validasi response
        if (
          ...
          throw new Exception('Data kendaraan MCEasy tidak ditemukan.');
      }
      ...
      if (
        ...
        throw new Exception(
            'Data kendaraan MCEasy tidak ditemukan.'
        );
    }
